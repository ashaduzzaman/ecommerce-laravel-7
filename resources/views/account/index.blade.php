                ...
                <div class="profile-left-sidebar">
                    <div class="profile-display">
                        <div class="display-column">
                            <img src="{{ asset('public/images/user.png') }}" alt="user_avatar">
                                    ...
                                    <tbody>
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                @else
                                                <td><span class="badge badge-danger text-uppercase">Unpaid</span></td>
                                                @endif
                                                @if ($order->status == 'pending')
                                                    <td><span class="badge badge-primary text-uppercase">Pending</span></td>
                                                @elseif($order->status == 'processing')
                                                    <td><span class="badge badge-info text-uppercase">Processing</span></td>
                                                @elseif($order->status == 'completed')
                                                    <td><span class="badge badge-success text-uppercase">Delivered</span></td>
                                                @else
                                                    <td><span class="badge badge-danger text-uppercase">Cancel</span></td>
                                                @endif
                                            </tr>
                                        @endforeach
                                    </tbody>
